...
export class Backend implements backendInterface {
    ...
    async getApplications(): Promise<Array<LoanApplication>> {
        if (this.processError) {
            try {
    ...
    async submitApplication(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateStatus(arg0: bigint, arg1: LoanStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStatus(arg0, to_candid_LoanStatus_n11(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
